...
class ENS {
  constructor(embark, _options) {
    ...
    self.embark.registerActionForEvent("contracts:deploy:afterAll", (cb) => {      
      self.events.request('contracts:contract', "ENSRegistry", (registry) => {
        self.events.request('contracts:contract', "FIFSRegistrar", (registrar) => {
          let config = {
            registryAbi: registry.abiDefinition, 
            registryAddress: registry.deployedAddress,
            registrarAbi: registrar.abiDefinition,
            registrarAddress: registrar.deployedAddress
          };
